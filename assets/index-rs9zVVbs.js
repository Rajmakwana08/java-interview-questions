(function(){const B=document.createElement("link").relList;if(B&&B.supports&&B.supports("modulepreload"))return;for(const L of document.querySelectorAll('link[rel="modulepreload"]'))ge(L);new MutationObserver(L=>{for(const Q of L)if(Q.type==="childList")for(const ce of Q.addedNodes)ce.tagName==="LINK"&&ce.rel==="modulepreload"&&ge(ce)}).observe(document,{childList:!0,subtree:!0});function m(L){const Q={};return L.integrity&&(Q.integrity=L.integrity),L.referrerPolicy&&(Q.referrerPolicy=L.referrerPolicy),L.crossOrigin==="use-credentials"?Q.credentials="include":L.crossOrigin==="anonymous"?Q.credentials="omit":Q.credentials="same-origin",Q}function ge(L){if(L.ep)return;L.ep=!0;const Q=m(L);fetch(L.href,Q)}})();var Eo={exports:{}},gr={},bo={exports:{}},_={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Cu;function Dd(){if(Cu)return gr;Cu=1;var j=To(),B=Symbol.for("react.element"),m=Symbol.for("react.fragment"),ge=Object.prototype.hasOwnProperty,L=j.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,Q={key:!0,ref:!0,__self:!0,__source:!0};function ce(de,W,be){var ve,ee={},K=null,We=null;be!==void 0&&(K=""+be),W.key!==void 0&&(K=""+W.key),W.ref!==void 0&&(We=W.ref);for(ve in W)ge.call(W,ve)&&!Q.hasOwnProperty(ve)&&(ee[ve]=W[ve]);if(de&&de.defaultProps)for(ve in W=de.defaultProps,W)ee[ve]===void 0&&(ee[ve]=W[ve]);return{$$typeof:B,type:de,key:K,ref:We,props:ee,_owner:L.current}}return gr.Fragment=m,gr.jsx=ce,gr.jsxs=ce,gr}var Pu;function jd(){return Pu||(Pu=1,Eo.exports=Dd()),Eo.exports}var Te=jd(),Lu=To(),Ti={},Co={exports:{}},Ne={},Po={exports:{}},Io={};/**
 * @license React
...
`},{id:1,question:"",answer:"",codeExample:""}],ge=L=>{B(j===L?null:L)};return Te.jsxs("div",{className:"app-container",children:[Te.jsx("h1",{children:"java Interview Questions"}),Te.jsx("div",{className:"questions-container",children:m.map(L=>Te.jsxs("div",{className:"question-item",children:[Te.jsx("button",{className:`question-button ${j===L.id?"active":""}`,onClick:()=>ge(L.id),children:L.question}),j===L.id&&Te.jsxs("div",{className:"answer-container",children:[Te.jsxs("div",{className:"answer",children:[Te.jsx("h3",{children:"Answer:"}),Te.jsx("p",{children:L.answer})]}),L.codeExample&&Te.jsxs("div",{className:"code-example",children:[Te.jsx("h3",{children:"Code Example:"}),Te.jsx("pre",{children:Te.jsx("code",{children:L.codeExample})})]})]})]},L.id))})]})}Rd.createRoot(document.getElementById("root")).render(Te.jsx(Lu.StrictMode,{children:Te.jsx(Fd,{})}));
